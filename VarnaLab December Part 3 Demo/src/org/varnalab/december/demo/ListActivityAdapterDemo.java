...
import org.varnalab.december.demo.ListActivityPreDemo.JSONTask;
...
public class ListActivityAdapterDemo extends Activity
		...
		protected void onPostExecute(String result) {
			if (result.equals("null") || result == null) {
				...
				try {
					...
					// Temp variable to store Json Information
							...
							// creating new HashMap
		        				...
		        				for (String tag : tags) {
		        					...
		        					if (json_data.has(tag)) {
		        						//Log.d(TAG, json_data.getString(tag));
